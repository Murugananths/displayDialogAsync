...
/***/ "./node_modules/@microsoft/office-js-helpers/dist/office.helpers.js":
/*!**************************************************************************!*\
  !*** ./node_modules/@microsoft/office-js-helpers/dist/office.helpers.js ***!
  \**************************************************************************/
...
var office_apis_helpers_1 = __webpack_require__(/*! ../utilities/office-apis-helpers */ "./src/utilities/office-apis-helpers.ts"); // The initialize function must be run each time a new page is loaded
...
function getLoginfirst(event) {
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      // Your code goes here
      clickEvent = event;
      office_apis_helpers_1.loginpopup();
      localStorage.setItem("isEvent", event.source.id.toString());
      office_apis_helpers_1.SetRuntimeVisibleHelper(true);
      office_apis_helpers_1.updateRibbon();
      event.completed();
      return [2
      /*return*/
      ];
...
function getLogout(event) {
  ...
  localStorage.setItem("isEvent", event.source.id.toString());
  office_apis_helpers_1.SetRuntimeVisibleHelper(true);
  office_apis_helpers_1.updateRibbon(); // Be sure to indicate when the add-in command function is complete
...
/***/ "./src/utilities/office-apis-helpers.ts":
/*!**********************************************!*\
  !*** ./src/utilities/office-apis-helpers.ts ***!
  \**********************************************/
/*! no static exports found */
...
var OfficeHelpers = __webpack_require__(/*! @microsoft/office-js-helpers */ "./node_modules/@microsoft/office-js-helpers/dist/office.helpers.js");

exports.SetRuntimeVisibleHelper = function (visible) {
  var p;
...
exports.SetStartupBehaviorHelper = function (isStarting) {
  if (isStarting) {
  ...
  var g = taskpane_1.getGlobal();
  g.isStartOnDocOpen = isStarting;
};

function updateRibbon() {
  // Update ribbon based on state tracking
  var g = taskpane_1.getGlobal(); // @ts-ignore

  OfficeRuntime.ui.getRibbon() // @ts-ignore
...
function loginpopup() {
  return __awaiter(this, void 0, void 0, function () {
    ...
    var g;
    return __generator(this, function (_a) {
      g = taskpane_1.getGlobal();
      if (OfficeHelpers.Authenticator.isAuthDialog()) return [2
      /*return*/
      ];
  ...
  try {
    Excel.run(function (context) {
      return __awaiter(_this, void 0, void 0, function () {
        var range;
        return __generator(this, function (_a) {
          range = context.workbook.getSelectedRange(); //let selectedOption = 'Communications';
...
exports.generateCustomFunction = generateCustomFunction; //This will check if state is initialized, and if not, initialize it.
//Useful as there are multiple entry points that need the state and it is not clear which one will get called first.

function ensureStateInitialized(isOfficeInitializing) {
  return __awaiter(this, void 0, void 0, function () {
    var g, initValue, addinState;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          g.state = {
            ...
            updateRct: function () {},
            setTaskpaneStatus: function (opened) {
...
exports.ensureStateInitialized = ensureStateInitialized;
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          g_1 = taskpane_1.getGlobal();

          if (g_1.state === undefined) {
            return [2
            /*return*/
            ];
          }

          if (!g_1.state.isInitialized) return [3
          /*break*/
          , 2];
          return [4
          /*yield*/
          , Excel.run(function (context) {
            return __awaiter(_this, void 0, void 0, function () {
              ...
              return __generator(this, function (_a) {
                switch (_a.label) {
                  case 0:
                    table = context.workbook.tables.getItem('ExpensesTable');
                    if (!(table !== undefined)) return [3
                    /*break*/
                    , 2];
...
exports.monitorSheetChanges = monitorSheetChanges;
